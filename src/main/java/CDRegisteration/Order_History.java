...
/*
     ...
     *  8. Search 'Complete' and download report
     *  9. Verify downloads completed
...
public class Order_History {
    ...
    public void setup() {
        ...
        try {
            ...
            System.out.println("WebDriver setup successful for OrderHistory test.");
    ...
    public void testOrderHistoryMenu() {
        System.out.println("\n========== Step 8: Click 'Order History' from sidebar ==========");
        try {
            WebDriverWait sidebarWait = new WebDriverWait(driver, Duration.ofSeconds(20));
            WebElement OrderHistoryMenu = sidebarWait.until(
                ExpectedConditions.elementToBeClickable(By.xpath("//a[normalize-space()='Order History']")));
            OrderHistoryMenu.click();
        } catch (Exception e) {
            Assert.fail("FAILED [Trade History]: Could not click 'Order History'. Reason: " + e.getMessage());
        }
    }  

    @Test(priority = 9, dependsOnMethods = "testOrderHistoryMenu")
    public void testSearchAndDownloadBuy() throws Exception {
        System.out.println("\n========== Step 9: Search keyword 'Complete' and CD Invoices ==========");
        searchAndDownload("Complete");
    ...
    private void searchAndDownload(String keyword) throws Exception {
    	...
    	WebElement searchBox = wait.until(ExpectedConditions.elementToBeClickable(
    		    By.xpath("//*[@placeholder=\"Search keyword\"]")));
