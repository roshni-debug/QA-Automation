...
public class OwnCDs_Utilize {
    ...
    @Test(priority = 10, dependsOnMethods = "testClickUtilizeButton")
    ...
    @Test(priority = 11, dependsOnMethods = "testSelectMake")
    ...
    @Test(priority = 12, dependsOnMethods = "testSelectModel")
    ...
    @Test(priority = 13, dependsOnMethods = "testEnterDealerName")
    ...
    @Test(priority = 14, dependsOnMethods = "testClickContinueAfterDealer")
    ...
    @Test(priority = 15, dependsOnMethods = "testClickConfirmUtilize")
