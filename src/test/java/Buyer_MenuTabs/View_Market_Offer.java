...
public class View_Market_Offer {
    ...
    @Test(priority = 9, dependsOnMethods = "testNavigateToViewMarketOffer")
    ...
    @Test(priority = 10, dependsOnMethods = "testClickViewAllOffer")
    ...
    @Test(priority = 11, dependsOnMethods = "testClickPlaceOfferToBuy")
    ...
    @Test(priority = 13, dependsOnMethods = "testClickCreateBid")
